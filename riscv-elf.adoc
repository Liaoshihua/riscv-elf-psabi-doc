...
ELF Reloc Type:: The name of the relocation
...
Caculation:: Formula for how to resolve the relocation value; definitions of the
...
.2+| 4       .2+| [.relocname]#R_RISCV_COPY#          .2+| Runtime |                   .2+| Must be in executable; not allowed in shared library
                                                                  <|
.2+| 5       .2+| [.relocname]#R_RISCV_JUMP_SLOT#     .2+| Runtime | _wordclass_       .2+| Indicates the symbol associated with a PLT entry
                                                                  <| S
