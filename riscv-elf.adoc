...
[[rv-st-other]]
.RISC-V specific value for `st_other` flags.
[cols="3,1"]
[width=60%]
|===
| Name                 | Mask
...
<<reloc-table>> provides details of the RISC-V ELF relocations (instruction
...
[[var-reloc-calc]]
.Variable used in relocation calculation
[%autowidth]
|===
...
[[var-reloc-field]]
.Variable used in relocation fields
[%autowidth]
|===
| Variable    | Description
